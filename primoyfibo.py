#Elabore un algoritmo que lea dos números enteros y se sumen; si el resultado de la suma es par, 
#calcule el numero de términos de la serie de Fibonacci. Si es impar, evalúe si es primo o no
